...
const STATUS_LABEL_MAP: Record<OrderStatus, { zh: string; en: string; de: string; ja: string; ko: string; es: string; it: string; vi: string
  fr: string }> = {
  all: { zh: '全部', en: 'All', de: 'Alle', ja: 'すべて', ko: '전체', es: 'Todos', it: 'Tutti', vi: 'Tất cả', fr: 'Tous' },
  pending_pay: { zh: '待付款', en: 'Awaiting payment', de: 'Zahlung ausstehend', ja: '支払い待ち', ko: '결제 대기', es: 'Pago pendiente', it: 'In attesa di pagamento', vi: 'Chờ thanh toán', fr: 'En attente de paiement' },
  paid: { zh: '待支付', en: 'To ship', de: 'Zu versenden', ja: '発送待ち', ko: '발송 대기', es: 'Por enviar', it: 'Da spedire', vi: 'Chờ giao', fr: 'Pour expédier' },
  shipped: { zh: '正在出库', en: 'Preparing shipment', de: 'Versandvorbereitung', ja: '出荷準備中', ko: '출고 준비 중', es: 'Preparando envío', it: 'Preparazione spedizione', vi: 'Đang chuẩn bị giao hàng', fr: 'Préparation de l\'expédition' },
  in_transit: { zh: '正在配送', en: 'In transit', de: 'Unterwegs', ja: '配送中', ko: '배송 중', es: 'En tránsito', it: 'In consegna', vi: 'Đang giao', fr: 'En transit' },
  delivered: { zh: '已签收', en: 'Delivered', de: 'Zugestellt', ja: '配達完了', ko: '배송 완료', es: 'Entregado', it: 'Consegnato', vi: 'Đã giao', fr: 'Livré' },
  completed: { zh: '订单完成', en: 'Completed', de: 'Abgeschlossen', ja: '注文完了', ko: '주문 완료', es: 'Completado', it: 'Completato', vi: 'Hoàn tất', fr: 'Terminé' },
...
function formatOrderAddress(addr: ApiOrder['address'], lang: Lang): string {
  ...
  const parts: string[] = []
  const labelMaps = {
    recipient: { zh: '收件人：', en: 'Recipient: ', de: 'Empfänger: ' , ja: '受取人：', ko: '수령인: ', es: 'Destinatario: ', it: 'Destinatario: ', vi: 'Người nhận: ', fr: 'Destinataire:' },
    phone: { zh: '电话：', en: 'Phone: ', de: 'Telefon: ' , ja: '電話：', ko: '전화: ', es: 'Teléfono: ', it: 'Telefono: ', vi: 'Điện thoại: ', fr: 'Téléphone:' },
    email: { zh: '邮箱：', en: 'Email: ', de: 'E-Mail: ' , ja: 'メール：', ko: '이메일: ', es: 'Correo: ', it: 'Email: ', vi: 'Email: ', fr: 'E-mail:' },
    region: { zh: '地区：', en: 'Region: ', de: 'Region: ' , ja: '地域：', ko: '지역: ', es: 'Región: ', it: 'Regione: ', vi: 'Khu vực: ', fr: 'Région:' },
    postal: { zh: '邮编：', en: 'Postal code: ', de: 'PLZ: ' , ja: '郵便番号：', ko: '우편번호: ', es: 'Código postal: ', it: 'CAP: ', vi: 'Mã bưu điện: ', fr: 'Code Postal:' },
    detail: { zh: '详细地址：', en: 'Address: ', de: 'Adresse: ' , ja: '詳細住所：', ko: '상세 주소: ', es: 'Dirección: ', it: 'Indirizzo: ', vi: 'Địa chỉ: ', fr: 'Adresse:' },
  }
  ...
  const handleShip = async () => {
    ...
    try {
      ...
      if (typeof res.settleAmount === 'number') {
        ...
        showToast(
          tr(lang, { zh: '发货成功', en: 'Shipment successful', de: 'Versand erfolgreich', ja: '発送が完了しました', ko: '발송이 완료되었습니다', es: 'Envío exitoso', it: 'Spedizione riuscita', vi: 'Giao hàng thành công', fr: 'Expédition réussie'}),
          'success',
        )
      }
    } catch (e: any) {
  ...
  return (
    <div className="merchant-orders-page merchant-orders-page--v2">
      <header className="merchant-orders-header merchant-orders-header--v2">
        <div className="merchant-orders-header-main">
          ...
          <div className="merchant-orders-header-copy">
            <h1 className="merchant-orders-title">
              {tr(lang, { zh: '店铺订单', en: 'Shop orders', de: 'Shop-Bestellungen', ja: 'ショップ注文', ko: '쇼핑몰 주문', es: 'Pedidos de la tienda', it: 'Ordini del negozio', vi: 'Đơn hàng cửa hàng', fr: 'Commandes en magasin'})}
            </h1>
        ...
        <div className="merchant-orders-stats" role="group" aria-label={tr(lang, { zh: '订单快捷筛选', en: 'Order quick filters', de: 'Schnellfilter für Bestellungen', ja: '注文クイックフィルター', ko: '주문 빠른 필터', es: 'Filtros rápidos de pedidos', it: 'Filtri rapidi ordini', vi: 'Lọc đơn hàng nhanh', fr: 'Commander des filtres rapides'})}>
          <button
            type="button"
          ...
          >
            ...
            <div className="merchant-orders-stat-body">
              ...
              <span className="merchant-orders-stat-label">
                {tr(lang, { zh: '全部订单', en: 'All orders', de: 'Alle Bestellungen', ja: 'すべての注文', ko: '전체 주문', es: 'Todos los pedidos', it: 'Tutti gli ordini', vi: 'Tất cả đơn hàng', fr: 'Toutes les commandes'})}
              </span>
            </div>
          </button>
          <button
          ...
          >
            ...
            <div className="merchant-orders-stat-body">
              ...
              <span className="merchant-orders-stat-label">
                {tr(lang, { zh: '待发货', en: 'To ship', de: 'Zu versenden', ja: '発送待ち', ko: '발송 대기', es: 'Por enviar', it: 'Da spedire', vi: 'Chờ giao', fr: 'Pour expédier'})}
              </span>
            </div>
          </button>
          <button
          ...
          >
            ...
            <div className="merchant-orders-stat-body">
              ...
              <span className="merchant-orders-stat-label">
                {tr(lang, { zh: '配送中', en: 'In transit', de: 'Unterwegs', ja: '配送中', ko: '배송 중', es: 'En tránsito', it: 'In consegna', vi: 'Đang giao', fr: 'En transit'})}
              </span>
            </div>
          </button>
        </div>
      ...
      {pendingShipCount > 0 && ordersInsightText ? (
        <MerchantDashboardInsight
          ...
          kicker={tr(lang, { zh: '发货提醒', en: 'Shipping reminder', de: 'Versanderinnerung', ja: '発送リマインダー', ko: '발송 알림', es: 'Recordatorio de envío', it: 'Promemoria spedizione', vi: 'Nhắc giao hàng', fr: 'Rappel d\'expédition'})}
          text={ordersInsightText}
          lang={lang}
          actionLabel={tr(lang, { zh: '查看待发货', en: 'View to ship', de: 'Zu versenden anzeigen', ja: '発送待ちを表示', ko: '발송 대기 보기', es: 'Ver por enviar', it: 'Vedi da spedire', vi: 'Xem chờ giao', fr: 'Vue à expédier'})}
          ...
          <div className="merchant-orders-search merchant-orders-search--v2">
            <label className="merchant-orders-search-field">
              ...
              <input
                ...
                placeholder={tr(lang, { zh: '搜索订单号', en: 'Search by order number', de: 'Nach Bestellnummer suchen', ja: '注文番号で検索', ko: '주문번호 검색', es: 'Buscar por número de pedido', it: 'Cerca per numero ordine', vi: 'Tìm theo mã đơn hàng', fr: 'Recherche par numéro de commande'})}
                value={orderNoSearch}
                onChange={(e) => {
            ...
            <button
              ...
              aria-label={
                refreshing
                  ? tr(lang, { zh: '刷新中', en: 'Refreshing', de: 'Refreshing', ja: '更新中', ko: '새로고침 중', es: 'Actualizando', it: 'Aggiornamento', vi: 'Đang làm mới', fr: 'Rafraîchissant'})
                  : tr(lang, { zh: '刷新订单列表', en: 'Refresh order list', de: 'Bestellliste aktualisieren', ja: '注文一覧を更新', ko: '주문 목록 새로고침', es: 'Actualizar lista de pedidos', it: 'Aggiorna elenco ordini', vi: 'Làm mới danh sách đơn hàng', fr: 'Actualiser la liste des commandes'})
              }
              title={
                tr(lang, { zh: '刷新订单列表（管理员修改状态后会同步显示）', en: 'Refresh order list (sync changes made in admin)', de: 'Bestellliste aktualisieren (Änderungen aus dem Admin synchronisieren)', ja: '注文一覧を更新（管理画面での変更を同期）', ko: '주문 목록 새로고침(관리자 변경 사항 동기화)', es: 'Actualizar lista de pedidos (sincronizar cambios del admin)', it: 'Aggiorna elenco ordini (sincronizza modifiche admin)', vi: 'Làm mới danh sách đơn (đồng bộ thay đổi từ quản trị)', fr: 'Actualiser la liste des commandes (synchroniser les modifications apportées dans l\'administrateur)'})
              }
            >
              <svg
          ...
          {refreshing && (
            <div className="merchant-orders-refresh-overlay" role="status" aria-live="polite">
              ...
              <span className="merchant-orders-refresh-overlay-text">
                {tr(lang, { zh: '正在刷新订单…', en: 'Refreshing orders…', de: 'Bestellungen werden aktualisiert…', ja: '注文を更新中…', ko: '주문 새로고침 중…', es: 'Actualizando pedidos…', it: 'Aggiornamento ordini…', vi: 'Đang làm mới đơn hàng…', fr: 'Des commandes rafraîchissantes…'})}
              </span>
            </div>
          )}
          {showInitialSkeleton ? (
                ...
                >
                  <div className="merchant-orders-card-top">
                    <div className="merchant-orders-card-top-left">
                      <span className="merchant-orders-card-chip">
                        {tr(lang, { zh: '订单号', en: 'Order', de: 'Bestellung', ja: '注文番号', ko: '주문', es: 'Pedido', it: 'Ordine', vi: 'Đơn hàng', fr: 'Commande'})}
                      </span>
                        ...
                        {order.firstProductImage ? (
                          <img
                            ...
                            alt={
                              ...
                              (tr(lang, { zh: '商品图片', en: 'Product image', de: 'Produktbild', ja: '商品画像', ko: '상품 이미지', es: 'Imagen del producto', it: 'Immagine prodotto', vi: 'Ảnh sản phẩm', fr: 'Image du produit'}))
                            }
                            loading="lazy"
                          />
                        ) : (
                  ...
                  <div className="merchant-orders-card-bar">
                    <div className="merchant-orders-card-pricing">
                      <div className="merchant-orders-card-price-block">
                        <span className="merchant-orders-card-price-label">
                          {tr(lang, { zh: '买家实付', en: 'Paid', de: 'Bezahlt', ja: '購入者支払額', ko: '구매자 결제', es: 'Pagado', it: 'Pagato', vi: 'Đã thanh toán', fr: 'Payé'})}
                        </span>
                      ...
                      <div className="merchant-orders-card-price-block merchant-orders-card-price-block--cost">
                        <span className="merchant-orders-card-price-label">
                          {tr(lang, { zh: '采购成本', en: 'Cost', de: 'Einkaufskosten', ja: '仕入れコスト', ko: '원가', es: 'Costo', it: 'Costo', vi: 'Chi phí', fr: 'Coût'})}
                        </span>
                      ...
                      <div className="merchant-orders-card-price-block merchant-orders-card-price-block--profit">
                        <span className="merchant-orders-card-price-label">
                          {tr(lang, { zh: '预估利润', en: 'Profit', de: 'Geschätzter Gewinn', ja: '見込み利益', ko: '예상 이익', es: 'Ganancia', it: 'Profitto', vi: 'Lợi nhuận', fr: 'Profit'})}
                        </span>
                        <span
                    ...
                    <div className="merchant-orders-card-actions">
                      ...
                      >
                        {tr(lang, { zh: '查看详情', en: 'Details', de: 'Details', ja: '詳細を見る', ko: '상세 보기', es: 'Detalles', it: 'Dettagli', vi: 'Chi tiết', fr: 'Détails'})}
                      </button>
                      {order.status === 'paid' && (
                        <button
                          type="button"
                        ...
                        >
                          {tr(lang, { zh: '立即发货', en: 'Ship now', de: 'Jetzt versenden', ja: '今すぐ発送', ko: '지금 발송', es: 'Enviar ahora', it: 'Spedisci ora', vi: 'Giao hàng ngay', fr: 'Expédier maintenant'})}
                        </button>
                      )}
                    </div>
                  </div>
      ...
      {orderDetail && !shipModalOpen
        ? createPortal(
            ...
            <div className="merchant-orders-drawer-head">
              ...
              >
                {tr(lang, { zh: '订单详情', en: 'Order details', de: 'Bestelldetails', ja: '注文詳細', ko: '주문 상세', es: 'Detalle del pedido', it: 'Dettagli ordine', vi: 'Chi tiết đơn hàng', fr: 'Détails de la commande'})}
              </h2>
              <button
                type="button"
            ...
            <div className="merchant-orders-drawer-body">
              <section className="merchant-orders-detail-block">
                <h3 className="merchant-orders-detail-block-title">
                  {tr(lang, { zh: '基本信息', en: 'Basic info', de: 'Grundinformationen', ja: '基本情報', ko: '기본 정보', es: 'Información básica', it: 'Informazioni di base', vi: 'Thông tin cơ bản', fr: 'Informations de base'})}
                </h3>
                <dl className="merchant-orders-detail-dl">
                  <dt>{tr(lang, { zh: '订单号', en: 'Order No.', de: 'Bestellnr.', ja: '注文番号', ko: '주문번호', es: 'N.º de pedido', it: 'N. ordine', vi: 'Mã đơn hàng', fr: 'Numéro de commande'})}</dt>
                  <dd>{orderDetail.orderNo}</dd>
                  <dt>{tr(lang, { zh: '下单时间', en: 'Order time', de: 'Bestellzeit', ja: '注文日時', ko: '주문 일시', es: 'Fecha del pedido', it: 'Data ordine', vi: 'Thời gian đặt hàng', fr: 'Heure de commande'})}</dt>
                  <dd>{formatDateTime(orderDetail.createdAt, lang)}</dd>
                  <dt>{tr(lang, { zh: '订单状态', en: 'Order status', de: 'Bestellstatus', ja: '注文ステータス', ko: '주문 상태', es: 'Estado del pedido', it: 'Stato ordine', vi: 'Trạng thái đơn hàng', fr: 'Statut de la commande'})}</dt>
                  <dd>
              ...
              <section className="merchant-orders-detail-block">
                <h3 className="merchant-orders-detail-block-title">
                  {tr(lang, { zh: '买家信息', en: 'Buyer info', de: 'Käuferinformationen', ja: '購入者情報', ko: '구매자 정보', es: 'Datos del comprador', it: 'Info acquirente', vi: 'Thông tin người mua', fr: 'Informations sur l\'acheteur'})}
                </h3>
                <div className="merchant-orders-detail-buyer-row">
                  <dl className="merchant-orders-detail-dl">
                    <dt>{tr(lang, { zh: '买家', en: 'Buyer', de: 'Käufer', ja: '購入者', ko: '구매자', es: 'Comprador', it: 'Acquirente', vi: 'Người mua', fr: 'Acheteur'})}</dt>
              ...
              <section className="merchant-orders-detail-block">
                <h3 className="merchant-orders-detail-block-title">
                  {tr(lang, { zh: '商品信息', en: 'Products', de: 'Produkte', ja: '商品情報', ko: '상품 정보', es: 'Productos', it: 'Prodotti', vi: 'Sản phẩm', fr: 'Produits'})}
                </h3>
              ...
              <section className="merchant-orders-detail-block">
                <h3 className="merchant-orders-detail-block-title">
                  {tr(lang, { zh: '订单金额', en: 'Order amount', de: 'Bestellbetrag', ja: '注文金額', ko: '주문 금액', es: 'Monto del pedido', it: 'Importo ordine', vi: 'Số tiền đơn hàng', fr: 'Montant de la commande'})}
                </h3>
                <div className="merchant-orders-detail-amount-row">
                  <span>{tr(lang, { zh: '买家实付金额', en: 'Buyer paid amount', de: 'Vom Käufer bezahlter Betrag', ja: '購入者支払金額', ko: '구매자 결제 금액', es: 'Monto pagado por el comprador', it: 'Importo pagato dall\'acquirente', vi: 'Số tiền người mua đã trả', fr: 'Montant payé par l\'acheteur'})}</span>
                ...
                <div className="merchant-orders-detail-amount-row merchant-orders-detail-amount-row--sub">
                  <span>{tr(lang, { zh: '采购总价', en: 'Purchase total', de: 'Einkaufssumme', ja: '仕入れ合計', ko: '구매 총액', es: 'Total de compra', it: 'Totale acquisto', vi: 'Tổng giá nhập', fr: 'Total des achats'})}</span>
              ...
              <section className="merchant-orders-detail-block">
                <h3 className="merchant-orders-detail-block-title">
                  {tr(lang, { zh: '收货地址', en: 'Shipping address', de: 'Lieferadresse', ja: '配送先住所', ko: '배송지', es: 'Dirección de envío', it: 'Indirizzo di spedizione', vi: 'Địa chỉ giao hàng', fr: 'Adresse de livraison'})}
                </h3>
              ...
              {orderDetail.trackingNo && (
                <section className="merchant-orders-detail-block">
                  <h3 className="merchant-orders-detail-block-title">
                    {tr(lang, { zh: '物流信息', en: 'Logistics', de: 'Logistik', ja: '配送情報', ko: '배송 정보', es: 'Logística', it: 'Logistica', vi: 'Vận chuyển', fr: 'Logistique'})}
                  </h3>
                  <dl className="merchant-orders-detail-dl">
                    <dt>{tr(lang, { zh: '物流单号', en: 'Tracking No.', de: 'Sendungsnr.', ja: '追跡番号', ko: '운송장 번호', es: 'N.º de seguimiento', it: 'N. tracking', vi: 'Mã vận đơn', fr: 'Numéro de suivi.'})}</dt>
              ...
              <section className="merchant-orders-detail-actions">
                {orderDetail.status === 'paid' && (
                  ...
                  >
                    {tr(lang, { zh: '发货', en: 'Ship', de: 'Versenden', ja: '発送', ko: '발송', es: 'Enviar', it: 'Spedisci', vi: 'Giao hàng', fr: 'Bateau'})}
                  </button>
                )}
                {orderDetail.status === 'shipped' && orderDetail.trackingNo && (
                  <button type="button" className="merchant-orders-detail-btn">
                    {tr(lang, { zh: '更新物流', en: 'Update logistics', de: 'Logistik aktualisieren', ja: '配送情報を更新', ko: '배송 정보 업데이트', es: 'Actualizar logística', it: 'Aggiorna logistica', vi: 'Cập nhật vận chuyển', fr: 'Mettre à jour la logistique'})}
                  </button>
                )}
                <button
                  type="button"
                  ...
                  onClick={() => setDetailOrder(null)}
                >
                  {tr(lang, { zh: '关闭', en: 'Close', de: 'Schließen', ja: '閉じる', ko: '닫기', es: 'Cerrar', it: 'Chiudi', vi: 'Đóng', fr: 'Fermer'})}
                </button>
              </section>
            </div>
          </aside>
          ...
          <div className="merchant-orders-settle-modal" onClick={(e) => e.stopPropagation()}>
            <div className="merchant-orders-settle-head">
              <h2 id="merchant-orders-settle-title" className="merchant-orders-settle-title">
                {tr(lang, { zh: '发货结算', en: 'Shipment settlement', de: 'Versandabrechnung', ja: '発送精算', ko: '발송 정산', es: 'Liquidación de envío', it: 'Liquidazione spedizione', vi: 'Thanh toán giao hàng', fr: 'Règlement des expéditions'})}
              </h2>
              <p className="merchant-orders-settle-order-no">
                {tr(lang, { zh: '订单号：', en: 'Order No: ', de: 'Order No: ', ja: '注文番号：', ko: '주문번호: ', es: 'N.º de pedido: ', it: 'N. ordine: ', vi: 'Mã đơn hàng: ', fr: 'Numéro de commande :'})}
                {settleOrder.orderNo}
              </p>
            </div>
            {settlePreviewLoading && (
              <div className="merchant-orders-settle-loading">
                {tr(lang, { zh: '加载结算信息中…', en: 'Loading settlement info…', de: 'Abrechnungsinformationen werden geladen…', ja: '精算情報を読み込み中…', ko: '정산 정보 불러오는 중…', es: 'Cargando información de liquidación…', it: 'Caricamento info liquidazione…', vi: 'Đang tải thông tin thanh toán…', fr: 'Chargement des informations sur le règlement…'})}
              </div>
            )}
            {settlePreviewError && (
              ...
              return (
                <>
                  <div className="merchant-orders-settle-card">
                    <div className="merchant-orders-settle-row merchant-orders-settle-row--amount">
                      <span className="merchant-orders-settle-label">
                        {tr(lang, { zh: '订单金额（买家实付）', en: 'Order amount (buyer paid)', de: 'Bestellbetrag (Käufer bezahlt)', ja: '注文金額（購入者支払額）', ko: '주문 금액(구매자 결제)', es: 'Monto del pedido (pagado por el comprador)', it: 'Importo ordine (pagato dall\'acquirente)', vi: 'Số tiền đơn hàng (người mua đã trả)', fr: 'Montant de la commande (payé par l\'acheteur)'})}
                      </span>
                      <span className="merchant-orders-settle-value">${orderAmount.toFixed(2)}</span>
                    </div>
                    <div className="merchant-orders-settle-row">
                      <span className="merchant-orders-settle-label">
                        {tr(lang, { zh: '采购总价', en: 'Purchase total', de: 'Einkaufssumme', ja: '仕入れ合計', ko: '구매 총액', es: 'Total de compra', it: 'Totale acquisto', vi: 'Tổng giá nhập', fr: 'Total des achats'})}
                      </span>
                    ...
                    <div className="merchant-orders-settle-row merchant-orders-settle-row--profit">
                      <span className="merchant-orders-settle-label">
                        {tr(lang, { zh: '利润金额', en: 'Profit amount', de: 'Gewinnbetrag', ja: '利益額', ko: '이익 금액', es: 'Monto de ganancia', it: 'Importo profitto', vi: 'Số tiền lợi nhuận', fr: 'Montant du bénéfice'})}
                      </span>
                    ...
                    <div className="merchant-orders-settle-row merchant-orders-settle-row--total">
                      <span className="merchant-orders-settle-label">
                        {tr(lang, { zh: '预计回款总额', en: 'Expected total payout', de: 'Erwartete Gesamtauszahlung', ja: '見込み入金合計', ko: '예상 입금 총액', es: 'Total estimado a recibir', it: 'Totale stimato da incassare', vi: 'Tổng tiền nhận dự kiến', fr: 'Paiement total attendu'})}
                      </span>
                    ...
                    <div className="merchant-orders-settle-wallet">
                      <span className="merchant-orders-settle-label">
                        {tr(lang, { zh: '当前店铺余额', en: 'Current shop balance', de: 'Aktuelles Shop-Guthaben', ja: '現在のショップ残高', ko: '현재 쇼핑몰 잔액', es: 'Saldo actual de la tienda', it: 'Saldo attuale del negozio', vi: 'Số dư cửa hàng hiện tại', fr: 'Solde actuel de la boutique'})}
                      </span>
                      <span className={`merchant-orders-settle-value ${!canSettle ? 'merchant-orders-settle-value--insufficient' : ''}`}>
                        ...
                        {!canSettle && (
                          <em className="merchant-orders-settle-insufficient">
                            {tr(lang, { zh: '（余额不足）', en: '(Insufficient balance)', de: '(Unzureichendes Guthaben)', ja: '（残高不足）', ko: '(잔액 부족)', es: '(Saldo insuficiente)', it: '(Saldo insufficiente)', vi: '(Số dư không đủ)', fr: '(Solde insuffisant)'})}
                          </em>
                        )}
                      </span>
                    </div>
                  ...
                  <div className="merchant-orders-settle-actions">
                    ...
                    >
                      {shipSubmitting
                        ? tr(lang, { zh: '提交中…', en: 'Submitting…', de: 'Submitting…', ja: '送信中…', ko: '제출 중…', es: 'Enviando…', it: 'Invio in corso…', vi: 'Đang gửi…', fr: 'Soumission…'})
                        : tr(lang, { zh: '确认发货并结算', en: 'Confirm shipment and settle', de: 'Versand bestätigen und abrechnen', ja: '発送・精算を確認', ko: '발송 및 정산 확인', es: 'Confirmar envío y liquidar', it: 'Conferma spedizione e liquidazione', vi: 'Xác nhận giao hàng và thanh toán', fr: 'Confirmer l\'expédition et régler'})}
                    </button>
                  </div>
                </>
              )
